        ...
        <div class="menu-user row">
            ...
            <div class="user col-xl-3 col-lg-4 col-sm-12">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="favorite ">
                        <a class="text-black text-decoration-none" href="{{ route('favorite.index') }}"><i class="fa-solid fa-heart fs-6 me-1 text-danger "></i><span class="fs-6 ">Yêu thích</span></a>
                    </div>
            ...
            <div class="info col-xl-9 col-lg-8 col-sm-12">
                            ...
                            <div class="swiper-wrapper" style="max-width: 350px;">
                                ...
                                <div class="swiper-slide col-xl-3 col-lg-6 col-sm-6 col-12 position-relative" style="height: 290px;">
                                    <a class="text-black" href="{{ route('product.detail', ['id' => $product->product_id]) }}">
                                        <div class="function d-flex justify-content-center align-items-center font-italic gap-1" id="icon-container">
                                            <a href="{{ route('productId.edit', $product->product_id) }}" style="font-size: 15px; color: gray; display: none;" class="btn edit-icon" data-toggle="modal" data-target="#exampleModalx{{$product->product_id}}">
                                                <i class="fa-solid fa-pen"></i>
                                            </a>
                                            <a href="#" style="font-size: 15px; color: gray; display: none;" type="button" class="btn delete-icon" data-toggle="modal" data-target="#exampleModal{{$product->product_id}}">
                                        ...
                                        <div class="text-book d-flex flex-column justify-content-center align-items-center">
                                            <h2 class="new__title pt-2 fs-6">{{$product->product_name}}</h2>
                                        </div>
                                    </a>
                                </div>
                                @endforeach
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{ route('productId.delete', $product->product_id) }}" class="btn btn-danger">Xóa</a>
                            </div>
                        </div>
                    </div>
                </div>
                @endforeach
                @foreach ($products as $product)
                <div class="modal fade" id="exampleModalx{{$product->product_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('productId.update', $product->product_id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group fs-6">
                                        <label for="inputEmail4">Tên tài liệu:</label>
                                        <input name="product_name" type="text" class="form-control" id="inputEmail4" value="{{ $product->product_name }}">
                                    </div>
                                    <div class="form-group fs-6">
                                        <label for="inputPassword4">Giới thiệu về tài liệu:</label>
                                        <textarea name="product_detail" type="text" class="form-control" style="height: 300px;" id="inputPassword4">{{ $product->product_detail }}</textarea>
                                    </div>
                                    <div class="form-group fs-6 overflow-hidden">
                                        <label class="text-start " for="inputAddress">Ảnh tài liệu:</label>
                                        <br>
                                        <div class="text-center ">
                                            <img style="width: 200px; margin: 0 auto;" id="previewImage" src="{{ $product->product_img }}" alt="">
                                            <br>
                                    ...
                                    <div class="form-group  fs-6 ">
                                        ...
                                        <input type="file" name="product_file" id="myFileInput" class="py-3" value="{{ $product->product_file }}" />
                                    </div>
                                    <div class="form-group  fs-6 ">
                                        <label for="inputEmail4 ">Thể loại</label>

                                        <input name="category" type="text" class="form-control" id="inputEmail4" value="{{ $product->category }}">
                                    </div>
                                    <div class=" modal-footer fs-5">
