...
<body>
    ...
    <div class="container-fluid">
        <form action="{{ route('signup.create') }}" method="post" id="signUp">
            @csrf
            ...
            <div class="form-group">
                <input name="username" type="text" class="form-control" id="exampleInputEmail1" placeholder="Tài khoản">
            </div>
            <div class="form-group">
                <input name="password" type="password" class="form-control" id="exampleInputPassword1" placeholder="Mật khẩu">
            </div>
            <div class="form-group">
                <input name="name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Họ và tên">
            </div>
            <div class="form-group">
                <input name="email" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Email">
            </div>
            <a href=""> <button type="submit" class="btn--">Đăng Ký</button></a>
            <div id="btn-signIn py-3 ">
                Bạn đã có tài khoản <a href="{{route('signin.index')}}" style="color: #717cb6;">Đăng nhập ngay</a>
            </div>
        </form>
    </div>
