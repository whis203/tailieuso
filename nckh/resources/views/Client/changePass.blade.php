    ...
    <div class="container-fluid mx-auto ">
        <form method="POST" action="{{ route('password.update') }}" class="mx-auto">
            ...
            <div class="form-group">
                <input class="w-100" type="email" id="email" name="email" value="{{ $email ?? old('email') }}" placeholder="Email của bạn" required autofocus>
            </div>
            <div class="form-group">

                <input class="w-100" type="password" id="password" name="password" placeholder="Mật khẩu mới" required>
            </div>
            <div class="form-group">
