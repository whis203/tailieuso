        ...
        <form>
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="email" class="form-control" id="inputEmail4" value="MHP1" />
            </div>
            <div class="form-group col-md-6">
              <label for="inputPassword4">Tên HP</label>
              <input type="text" class="form-control" value="Lập trình Java" />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="inputAddress2" value="0987654321" />
          </div>
          <br />
