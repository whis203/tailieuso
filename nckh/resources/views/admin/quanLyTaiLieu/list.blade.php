          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="{{route('managedocument.showFormEdit', [$product->product_id])}}"><i class="fa-solid fa-pen-to-square"></i></a>
                  <button type="button" style="border: none;background: none;" data-toggle="modal" data-target="#exampleModal{{$product->product_id}}">
