      ...
      <div class="card-content">
        ...
        <form action="{{ route('product.create') }}" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group ">
            ...
            <input type="text" name="product_name" class="form-control" id="inputPassword4" placeholder="Nhập tên tài liệu" />
          </div>

          <div class="form-group">
            <label for="inputAddress2">Giới thiệu</label>
            <input type="text" name="product_detail" class="form-control" id="inputAddress2" placeholder="Nhập giới thiệu" />
          </div>
          <div class="form-group">
            <label for="inputAddress2">File Ảnh</label>
            <input type="file" class="form-control" name="product_img" id="inputAddress2" placeholder="Nhập File" />
          </div>
          <div class="form-group">
            <label for="inputAddress2">File Tài Liệu</label>
            <input type="file" class="form-control" name="product_file" id="inputAddress2" placeholder="Nhập File" />
          </div>
          <div class="form-group">
